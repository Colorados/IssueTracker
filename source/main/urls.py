...
from issue_tracker.views import IndexView, IssueView, IssueCreateView, IssueEditView, issue_delete_view, ProjectsListView, ProjectDetailView, ProjectCreateView
